                ...
                <div className="max-w-sm w-full text-gray-600 space-y-5">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between text-sm">
                            ...
                            <Link to="" className="text-center text-red-600 hover:text-red-500">Forgot password?</Link>
                        </div>
                        <button
                    ...
                    <p className="text-center">Dont have an account? <Link to="/signup" className="font-medium text-red-600 hover:text-red-500">Sign up</Link></p>
                </div>
            </main>
        </div>
    )
